...
// import 'package:academiax/screens/hod_view_student_club_page.dart';
// import 'package:academiax/screens/hod_view_student_online_courses_page.dart';
// import 'package:academiax/screens/hod_view_students_projects_page.dart';
...
//               onPressed: () {
//                 Navigator.of(context).push(MaterialPageRoute(
//                     builder: (context) => HodViewStudentInternshipWorkPage(
//                         studentId: studentID, studentName: studentName)));
//               },
//               style: ElevatedButton.styleFrom(
//                 backgroundColor: Pallet.buttonColor,
...
//               onPressed: () {
//                 Navigator.of(context).push(MaterialPageRoute(
//                     builder: (context) => HodViewStudentProjectsPage(
//                           studentId: studentID,
...
//               onPressed: () {
//                 Navigator.of(context).push(MaterialPageRoute(
//                     builder: (context) => HodViewStudentOnlineCoursesPage(
//                           studentId: studentID,
//                           studentName: studentName,
//                         )));
//               },
...
//               onPressed: () {
//                 Navigator.of(context).push(MaterialPageRoute(
//                     builder: (context) => HodViewStudentClubPage(
//                           studentId: studentID,
//                           studentName: studentName,
//                         )));
//               },
...
class StudentDetailsPage extends StatelessWidget {
  ...
  const StudentDetailsPage({super.key, required this.studentDetails});
  ...
  //         ),
  //         Expanded(
  //           // 1. Wrap the value Text widget with Expanded
  //           child: Text(
  //             " $value",
  //             style: const TextStyle(
  //               fontSize: 18,
  ...
  Widget _buildDetailRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment:
            CrossAxisAlignment.start, // 1. Align items to start (top)
        ...
        children: [
          ...
          Expanded(
            child: Padding(
              // 2. Add Padding to the value Text for better spacing
              padding: const EdgeInsets.only(
                  left: 8.0), // Add some left padding for value
              child: Text(
                value,
                style: const TextStyle(
                  fontSize: 18,
